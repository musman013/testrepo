...
import { IApps, AppsService, AppsDetailsComponent, AppsListComponent, AppsNewComponent } from './index';
...
describe('AppsListComponent', () => {
  ...
  let constData:IApps[] = [
    ...
    {   
      ...
      groupId: 'groupId2',
      id: 2,
      jdbcPassword: 'jdbcPassword2',
      jdbcUrl: 'jdbcUrl2',
      jdbcUsername: 'jdbcUsername2',
      name: 'name2',
      processAdminApp: true,
      processManagement: true,
      scheduler: true,
  ...
  describe('Integration tests', () => {
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/apps/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
